...
After having both installed, download the latest version of the mod dll from the [Releases](https://github.com/guilherme-gm/KirieZ_DoraemonSoSMods/releases?q=Confirm+Beehive+Removal&expanded=true) page and add it to your BepInEx's plugins folder.
